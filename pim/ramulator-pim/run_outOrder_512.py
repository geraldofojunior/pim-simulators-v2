...
"sandiego.svd3"]
for f in files:
    cmd = "./ramulator --config filtered-trace-paper-configs/HMC-config-OoOrder-512.cfg --mode=cpu --stats /home/geraldo/Tools/ramulator-morphcore/results_morphCore_OoO/pim/"+f+".outOrder.hmc.pim --trace ../pin-3.5/new_traces/"+f+".cpu"
    print cmd
    os.system(cmd)