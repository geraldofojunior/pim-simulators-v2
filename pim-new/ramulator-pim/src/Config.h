...
private:
    ...
    int cpu_frequency;
    int core_num = 0;
    int pim_core_count = 32;
    int cacheline_size = 64;
    long expected_limit_insts = 0;
    int pim_cache_lines = 0;
    std::string pim_org = "in_order";
...
public:
    ...
    void set_pim_cache_lines(const int lines) {pim_cache_lines = lines;}
    void set_pim_core_count(const int cores) {pim_core_count = cores;}
    void set_pim_org(std::string org){pim_org = org;}
    ...
    int get_num_pim_cores() const {return pim_core_count;}
    int get_pim_cacheline_size() const {return pim_cache_lines;}
    ...
    int get_core_num() const {if(pim_mode_enabled()) return pim_core_count; else return core_num;}
